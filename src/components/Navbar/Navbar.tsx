...
export default function Navbar() {
  ...
  return (
    <div className='sticky w-screen h-[56px] flex justify-between items-center bg-black px-4'>
      <div className='flex items-center justify-start text-[17px] font-bold space-x-1'>
        ...
        <Link to='/Home' className='bg-clip-text font-bold text-transparent bg-gradient-to-r from-green-400 to-blue-500'>MYTASKS</Link>
      </div>
